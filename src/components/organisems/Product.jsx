     ...
     <section className="product spad">
        <div className="container mx-auto">
            ...
            <div className="flex flex-wrap product__filter">
                <div className="lg:w-3/12 md:w-6/12 lg:basis-3/12 md:basis-6/12 basis-full px-3 mix new-arrivals">
                ...
                <div className="lg:w-3/12 md:w-6/12 lg:basis-3/12 md:basis-6/12 basis-full px-3 mix hot-sales">
                    <div className="product__item">
